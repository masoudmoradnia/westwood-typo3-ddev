...
class ProductLevelsIndexer extends IndexerBase
{
    ...
    public function registerIndexerConfiguration(&$params, $pObj)
    {
        ...
        $customIndexer = array(
            'ProductLevels-indexer',
            ProductLevelsIndexer::KEY,
    ...
    public function customIndexer(array &$indexerConfig, IndexerRunner &$indexerObject): string
    {
        ...
        $counter = 0;
        foreach($productlevels as $record) {
            ...
            // Compile the information, which should go into the index.
                ...
                // Link to detail view
                $params = '&tx_wwapi_api[productlevel_id]='.$record['id'].'&tx_wwapi_api[controller]=Item';
                ...
                $indexerObject->storeInIndex(
                    ...
                    $title,                         // record title
                    ProductLevelsIndexer::KEY,            // content type
